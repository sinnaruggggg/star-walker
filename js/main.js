        ...
        window.DRACOLoader = DRACOLoader;  // ★ Draco 압축 모델 지원
        ...
        // ★ 무기 시스템 (30종) - weight 추가 (적재량 시스템)
        const WEAPONS = [
            // Tier 1 - 기본 무기 (셔틀~탐사정) - weight: 5~8
            { id: 'laser_basic', name: '기본 레이저', tier: 1, damage: 10, fireRate: 2.0, range: 500, energy: 5, weight: 5, price: 200, desc: '가장 기본적인 레이저 무기' },
            { id: 'laser_dual', name: '듀얼 레이저', tier: 1, damage: 18, fireRate: 1.8, range: 500, energy: 8, weight: 7, price: 400, desc: '두 줄기 레이저 동시 발사' },
            { id: 'machinegun', name: '우주 기관총', tier: 1, damage: 5, fireRate: 8.0, range: 300, energy: 2, weight: 6, price: 350, desc: '빠른 연사 속도의 실탄 무기' },
            { id: 'flare_launcher', name: '플레어 런처', tier: 1, damage: 15, fireRate: 1.0, range: 200, energy: 10, weight: 8, price: 300, desc: '미사일 교란용 플레어' },

            // Tier 2 - 중급 무기 (인터셉터~화물선) - weight: 10~18
            { id: 'laser_triple', name: '트리플 레이저', tier: 2, damage: 25, fireRate: 1.5, range: 600, energy: 12, weight: 12, price: 800, desc: '세 줄기 레이저 동시 발사' },
            { id: 'pulse_laser', name: '펄스 레이저', tier: 2, damage: 30, fireRate: 3.0, range: 450, energy: 15, weight: 10, price: 1000, desc: '고속 펄스 에너지탄' },
            { id: 'missile_basic', name: '기본 미사일', tier: 2, damage: 50, fireRate: 0.5, range: 1000, energy: 20, weight: 18, price: 1200, desc: '유도 기능 없는 직선 미사일' },
            { id: 'gatling', name: '개틀링건', tier: 2, damage: 8, fireRate: 12.0, range: 350, energy: 3, weight: 15, price: 1500, desc: '초고속 회전 기관포' },
            { id: 'shotgun', name: '스페이스 산탄총', tier: 2, damage: 40, fireRate: 0.8, range: 150, energy: 18, weight: 14, price: 900, desc: '근거리 광역 피해' },

            // Tier 3 - 고급 무기 (코르벳~레이서) - weight: 15~28
            { id: 'beam_laser', name: '빔 레이저', tier: 3, damage: 45, fireRate: 0.1, range: 800, energy: 25, weight: 18, price: 3000, desc: '지속 조사형 고출력 빔' },
            { id: 'plasma_cannon', name: '플라즈마 캐논', tier: 3, damage: 60, fireRate: 1.0, range: 600, energy: 30, weight: 22, price: 3500, desc: '고온 플라즈마 발사' },
            { id: 'ion_cannon', name: '이온 캐논', tier: 3, damage: 35, fireRate: 1.5, range: 700, energy: 22, weight: 16, price: 2800, desc: '적 시스템 마비 효과' },
            { id: 'homing_missile', name: '호밍 미사일', tier: 3, damage: 70, fireRate: 0.4, range: 1500, energy: 35, weight: 25, price: 4000, desc: '열추적 유도 미사일' },
            { id: 'sniper_cannon', name: '스나이퍼 캐논', tier: 3, damage: 100, fireRate: 0.3, range: 2000, energy: 40, weight: 28, price: 4500, desc: '초장거리 정밀 사격' },
            { id: 'emp_missile', name: 'EMP 미사일', tier: 3, damage: 20, fireRate: 0.3, range: 800, energy: 45, weight: 20, price: 5000, desc: '전자기 펄스로 시스템 마비' },

            // Tier 4 - 전함급 무기 (프리깃~크루저) - weight: 25~45
            { id: 'railgun', name: '레일건', tier: 4, damage: 150, fireRate: 0.2, range: 2500, energy: 60, weight: 40, price: 8000, desc: '전자기 가속 관통탄' },
            { id: 'gauss_cannon', name: '가우스 캐논', tier: 4, damage: 120, fireRate: 0.4, range: 1800, energy: 50, weight: 35, price: 7000, desc: '자기장 가속 중금속탄' },
            { id: 'torpedo', name: '광자 어뢰', tier: 4, damage: 200, fireRate: 0.15, range: 3000, energy: 80, weight: 45, price: 10000, desc: '대형 함선용 중어뢰' },
            { id: 'cluster_missile', name: '클러스터 미사일', tier: 4, damage: 30, fireRate: 0.5, range: 1200, energy: 55, weight: 38, price: 9000, desc: '분산 탄두 8발 동시 폭발' },
            { id: 'tesla_coil', name: '테슬라 코일', tier: 4, damage: 80, fireRate: 2.0, range: 400, energy: 45, weight: 30, price: 8500, desc: '연쇄 전기 방전' },
            { id: 'disruptor', name: '디스럽터', tier: 4, damage: 90, fireRate: 0.8, range: 600, energy: 55, weight: 28, price: 9500, desc: '실드 특화 파괴 무기' },

            // Tier 5 - 최종병기 (배틀십~플래그십) - weight: 40~80
            { id: 'antimatter_cannon', name: '반물질 캐논', tier: 5, damage: 300, fireRate: 0.1, range: 2000, energy: 100, weight: 60, price: 25000, desc: '반물질 폭발로 광역 피해' },
            { id: 'quantum_cannon', name: '양자 캐논', tier: 5, damage: 250, fireRate: 0.15, range: 2500, energy: 90, weight: 55, price: 22000, desc: '양자 불확정성 관통' },
            { id: 'nuke_missile', name: '핵 미사일', tier: 5, damage: 500, fireRate: 0.05, range: 5000, energy: 150, weight: 80, price: 30000, desc: '전술 핵탄두 미사일' },
            { id: 'gravity_well', name: '중력장 발생기', tier: 5, damage: 50, fireRate: 0.2, range: 1000, energy: 120, weight: 50, price: 28000, desc: '중력장으로 적 속박' },
            { id: 'mine_layer', name: '퀀텀 마인', tier: 5, damage: 180, fireRate: 0.3, range: 100, energy: 70, weight: 42, price: 20000, desc: '공간에 기뢰 설치' },
            { id: 'singularity_launcher', name: '특이점 발사기', tier: 5, damage: 400, fireRate: 0.08, range: 1500, energy: 130, weight: 70, price: 35000, desc: '미니 블랙홀 생성' },
            { id: 'darkmatter_beam', name: '암흑물질 빔', tier: 5, damage: 350, fireRate: 0.1, range: 3000, energy: 110, weight: 65, price: 32000, desc: '암흑물질 에너지 방출' },
            { id: 'tachyon_beam', name: '타키온 빔', tier: 5, damage: 280, fireRate: 0.2, range: 4000, energy: 95, weight: 48, price: 28000, desc: '초광속 입자 빔' },
            { id: 'omega_cannon', name: '오메가 캐논', tier: 5, damage: 1000, fireRate: 0.02, range: 3500, energy: 200, weight: 75, price: 50000, desc: '최종 병기, 행성급 파괴력' }
        ];
        ...
        // ★ 플레이어 무장 인벤토리
        // ★ 멀티모드: 서버 저장, 싱글모드: localStorage
        let playerArmory = JSON.parse(localStorage.getItem('milkyway-armory') || '{}');
        let armoryLoaded = false;  // 서버에서 로드 완료 여부

        // ★ 무기고 서버에서 로드 (멀티모드 초기화용)
        async function loadArmoryFromServer() {
            ...
            try {
                ...
                if (serverData) {
                    ...
                    console.log('✅ 무기고 서버에서 로드됨');
                }
                armoryLoaded = true;
            } catch (e) {
                console.warn('무기고 서버 로드 실패:', e);
            }
        }
        ...
        function equipWeapon(shipId, weaponId, slotIndex) {
            ...
            if ((currentWeight - removedWeight + newWeight) > maxCapacity) {
                return { success: false, reason: 'capacity' };  // 적재량 초과
            }
        ...
        function getEquippedWeight(shipId) {
            ...
            // 장갑 무게 합산 (weight가 계수인 경우 기본 무게 20으로 계산)
            if (equipped.armor) {
                const armor = ARMORS.find(a => a.id === equipped.armor);
                if (armor) {
                    // armor.weight가 1.0, 0.9 등 계수인 경우 기본 무게 * 계수로 계산
                    const baseArmorWeight = 30;  // 기본 장갑 무게
        ...
        // ★★★ 무기 발사 시스템 ★★★
        const weaponSystem = {
            projectiles: [],        // 발사된 투사체들
            beams: [],              // 빔 레이저들
            lastFireTime: 0,        // 마지막 발사 시간
            isFiring: false,        // 발사 버튼 누르는 중
            fireRate: 0.15,         // 발사 간격 (초)
            projectileSpeed: 500,   // 투사체 속도
            projectileRange: 1000,  // 투사체 사거리
            damage: 15,             // 기본 데미지
            maxProjectiles: 50      // 최대 투사체 수
        };

        // ★★★ 우주정거장 반격 시스템 ★★★
        const stationDefense = {
            beams: [],              // 반격 빔들
            lastFireTime: {},       // 정거장별 마지막 발사 시간
            fireRate: 2.0,          // 반격 간격 (초)
            beamDuration: 0.5,      // 빔 지속 시간 (초)
            damage: 10,             // 반격 데미지
            range: 200              // 반격 사거리
        };
        ...
        async function loadSSILStateAsync() {
            ...
            try {
                ...
                if (serverData) {
                    ...
                    console.log('✅ SSIL 미션 서버에서 로드됨');
                }
            } catch (e) {
                console.warn('SSIL 상태 서버 로드 실패:', e);
                loadSSILState();  // 폴백: 로컬에서 로드
            }
        }
...
'4. 이모지를 적절히 사용하세요.';
        ...
        let cockpitMainHUD, cockpitSubHUD;  // 홀로그램 HUD (레거시)
        // ★ 새로운 유리 투영 HUD 시스템
        let glassHUD = {
            reticle: null,          // 중앙 조준선 (선회 조작용)
            leftPanel: null,        // 좌측 상단: 속도
            leftBottomPanel: null,  // 좌측 하단: 연료, 헐
            rightPanel: null,       // 우측 상단: 좌표, 목표
            rightBottomPanel: null, // 우측 하단: 오토파일럿
            bottomPanel: null,      // 하단: 레이더
            isDragging: false,      // 조준선 드래그 중
            dragStart: { x: 0, y: 0 }
        };
        ...
        function updateKeplerOrbits(dt) {
            ...
            // ★★★ 멀티모드: J2000 기준 고정 계산 (모든 클라이언트 동일) ★★★
            // J2000.0 = 2000년 1월 1일 12:00 TT (천문학 표준 기준점)
            const J2000_EPOCH = Date.UTC(2000, 0, 1, 12, 0, 0);  // 밀리초

            let elapsedDays;
            if (window.gameMode === 'multi') {
                // 서버 동기화 시간 사용 (fallback: 로컬 시간)
            ...
            bodies.forEach(body => {
                ...
                // ★★★ 평균 근점이각 (Mean Anomaly) 계산 ★★★
                let M;
                if (window.gameMode === 'multi' && orbitData.period && orbitData.L0 !== undefined) {
                    // 멀티모드: J2000 기준 정확한 계산
                    // 현재 평균경도 = L0 + (360 / period) * elapsedDays
...
'답변은 간결하고 친절하게 해주세요.';
        ...
        // ★★★ Supabase에서 직접 로드 (admin.html과 동일한 방식) ★★★
        async function loadShipsData() {
            ...
            const showLoading = (msg) => {
                ...
                el.innerHTML = `<div style="font-size:24px;margin-bottom:20px;">🚀 LOADING SHIP DATA</div><div style="font-size:14px;color:#888;">${msg}</div>`;
            };
            ...
            // Supabase 클라이언트 생성 (admin.html과 동일)
            const supabase = window.supabase ? window.supabase.createClient(SUPABASE_URL, SUPABASE_ANON_KEY) : null;

            while (true) {
                attempt++;
                showLoading(`Supabase 연결 시도 ${attempt}...`);

                try {
                    if (!supabase) throw new Error('Supabase SDK 미로드');

                    console.log(`🚀 Supabase에서 ships 직접 로드 시도 ${attempt}...`);
                    ...
                    if (!shipsData || shipsData.length === 0) throw new Error('빈 데이터');

                    console.log('📦 Supabase ships 로드 성공:', shipsData.length, '개');
                    console.log('📦 첫 번째 우주선 raw:', shipsData[0]);

                    // ★★★ DB 컬럼명 그대로 사용 (snake_case) ★★★
                    shipsData.forEach(row => {
                        ...
                        if (ship) {
                            ...
                            if (row.capacity != null) ship.capacity = Number(row.capacity);  // 적재량
                            ...
                            console.log(`  ✅ ${ship.id}: turn_speed=${row.turn_speed} → turnSpeed=${ship.turnSpeed}`);
                        }
                    });
                    ...
                    if (window.currentShipType) {
                        ...
                        if (updated) {
                            ...
                            console.log(`🎯 현재 우주선: ${updated.id}, turnSpeed=${updated.turnSpeed}`);
                        }
                    }

                    shipsDataLoaded = true;
                    hideLoading();
                    console.log('✅ Supabase에서 스탯 적용 완료!');
                    return true;

                } catch (err) {
                    console.warn(`⚠️ 시도 ${attempt} 실패:`, err.message);
                    showLoading(`연결 실패: ${err.message} - 3초 후 재시도`);
        ...
        async function loadDataAndInit() {
            ...
            await loadShipsData();
            console.log('🎮 우주선 데이터 로드 완료, 태양계 초기화...');
        ...
        function createAndromedaGalaxy() {
            ...
            const position = new THREE.Vector3(52000000, 13000000, -32500000);  // ★ 2배 더 멀리
            const size = 1500000;
            ...
            // ===== 1. 나선 은하 형태의 별 점들 =====
            const starCount = 4000;  // ★ 밀도 1/3로 감소
            const positions = new Float32Array(starCount * 3);
            const colors = new Float32Array(starCount * 3);
            ...
            const stars = new THREE.Points(starGeometry, starMaterial);
            stars.frustumCulled = false;  // ★ 멀리서도 보이게
            ...
            for (let layer = 0; layer < 5; layer++) {
                ...
                const diskMat = new THREE.MeshBasicMaterial({
                    color: 0xaabbdd,
                    transparent: true,
                    opacity: 0.06 * Math.pow(0.6, layer),  // ★ 밝기 절반
                    blending: THREE.AdditiveBlending,
                    side: THREE.DoubleSide,
                    depthWrite: false
                });
            ...
            const bhSize = size * 0.015;  // 블랙홀 크기 (사건의 지평선)
            ...
            // ★ 광자구 (Photon Sphere) - 사건의 지평선 바로 바깥 밝은 링
            ...
            const diskFragmentShader = `
                ...
                void main() {
                    ...
                    // 온도 그라데이션 (안쪽: 하얀색/파랑, 바깥쪽: 빨강/주황)
                    vec3 hotColor = vec3(1.0, 1.0, 0.95);    // 가장 뜨거운 부분 (하얀색)
                    vec3 warmColor = vec3(1.0, 0.7, 0.2);    // 따뜻한 부분 (주황)
                    vec3 coolColor = vec3(0.8, 0.2, 0.05);   // 차가운 부분 (빨강)
            ...
            const diskInnerR = bhSize * 1.05;  // ★ 사건의 지평선 바로 바깥 (ISCO)
            ...
            accretionDisk.rotation.y = 0.3;  // 약간 기울임
            ...
            andromedaLabel.position.set(0, size * 0.8, 0);  // ★ 은하 위로 올림
        ...
        function reinitSolarSystemForMulti() {
            ...
            // 모든 천체 제거 (태양 포함, 은하 중심 블랙홀 제외)
            const galaxyCenterBH = bodies.find(b => b.name === '은하 중심');
            bodies.forEach(b => {
                if (b && b.mesh && b.name !== '은하 중심') {
                    scene.remove(b.mesh);
                    b.mesh.traverse(c => {
                        if (c.isCSS2DObject && c.element && c.element.parentNode) {
                            c.element.parentNode.removeChild(c.element);
                ...
                if (b && b.trail && b.name !== '은하 중심') scene.remove(b.trail);
            });
            ...
            (async function initMultiSolarSystem() {
                ...
                console.log('✅ 멀티모드: 서버 시간 동기화 완료 (경과:', elapsedDays.toFixed(2), '일)');
            })();
        ...
        function createCockpitForShip() {
            ...
            const mats = {
                hullInterior: new THREE.MeshStandardMaterial({
                    ...
                    depthWrite: false  // ★ HUD 가리지 않도록
                }),
                glass: new THREE.MeshStandardMaterial({
                    color: 0x88ccff, metalness: 0.1, roughness: 0.0,
                    transparent: true, opacity: 0.05, side: THREE.DoubleSide,  // ★ 투명도 감소
                    depthWrite: false  // ★ 깊이 쓰기 비활성화로 천체 가리지 않음
                }),
            ...
            cockpitGroup.position.set(0, 0, 0.5);  // 우주선 안쪽으로 더 이동
            ...
            rearShell.renderOrder = -100;  // ★ HUD보다 먼저 렌더링
            ...
            floatGroup.position.set(0, 0, 0.3);  // ★ 좌석/조종간 전체를 뒤쪽으로 이동
            ...
            function createGlassHUDPanel(posX, posY, posZ, width, height, canvasW, canvasH, curveAmount = 0.15) {
                ...
                // 정점을 곡면으로 변형 (유리 곡률 시뮬레이션)
                const pos = geometry.attributes.position;
                for (let i = 0; i < pos.count; i++) {
                    const x = pos.getX(i);
                    const y = pos.getY(i);
                    // 중앙에서 멀어질수록 뒤로 밀림 (구면 효과)
                ...
                const mat = new THREE.MeshBasicMaterial({
                    map: tex, transparent: true, opacity: 0.7,  // ★ 20% 더 투명
                    side: THREE.DoubleSide, blending: THREE.AdditiveBlending,
                    depthWrite: false, depthTest: false  // ★ rearShell 깊이 무시하여 클리핑 방지
                });
                const mesh = new THREE.Mesh(geometry, mat);
                mesh.position.set(posX, posY, posZ);
                mesh.renderOrder = 1000;  // ★ rearShell(-100)보다 확실히 나중에 렌더링
                mesh.frustumCulled = false;  // ★★★ 카메라 가까이 있어도 클리핑 방지
                return { ctx: canvas.getContext('2d'), tex, mesh, canvas, width, height };
            }

            // ★ 중앙 조준선 (정면 중앙, 선회 조작용) - 크기 유지, 속도 표시 포함
        ...
        function updateCockpitMonitors(time) {
            ...
            if (glassHUD.leftBottomPanel && glassHUD.leftBottomPanel.ctx) {
                ...
                if (hullPercent <= 30) {
                    ...
                    ctx.fillText('⚠ CRITICAL DAMAGE', W/2, PAD + 290);
                } else if (fuelPercent <= 20) {
                    ctx.fillStyle = '#ffaa00';
                    ctx.fillText('⚠ LOW FUEL WARNING', W/2, PAD + 290);
                } else {
                    ctx.fillStyle = '#00ff88';
                    ctx.fillText('◉ SYSTEMS NOMINAL', W/2, PAD + 290);
                }

                glassHUD.leftBottomPanel.tex.needsUpdate = true;
            }

            // === 우측 상단 패널 (768x1024) - 좌표, 목표 (2배 크기) ===
            if (glassHUD.rightPanel && glassHUD.rightPanel.ctx) {
                const ctx = glassHUD.rightPanel.ctx;
                const W = 768, H = 1024;
                const PAD = 100;  // ★ 상단 여백 (클리핑 방지)
                ctx.clearRect(0, 0, W, H);
        ...
        function updateCockpitView(dt) {
            ...
            if (isCockpitView) {
                ...
                // ★ 조종석이 z=0.3 뒤로 이동했으므로 시점도 이동 (의자보다는 앞쪽)
        ...
        function createPlayerShip(isReboard = false) {
            ...
            if (hasParkedShip) {
                ...
                if (window.gameMode === 'multi') {
                    ...
                    // 2. 그 다음 위성/정거장 위치 업데이트 (서버 동기화 시간 사용)
        ...
        function onDockingComplete(station) {
            ...
            window.isDockedToStation = true;
            AudioManager.playSFX('sfx_dock');  // ★ 도킹 효과음
        ...
        function updateArmoryDetail() {
            ...
            if (currentArmoryTab === 'weapons') {
                ...
                statsEl.innerHTML = `
                    ...
                    <div class="armory-stat-row"><span>📦 무게</span><span>${weapon.weight || 0}</span></div>
                ...
                const armorWeight = Math.round(30 * (armor.weight || 1));  // 기본 30 * 계수
                statsEl.innerHTML = `
                    ...
                    <div class="armory-stat-row"><span>📦 무게</span><span>${armorWeight}</span></div>
        ...
        function initCockpitControls() {
            ...
            canvas.addEventListener('mousemove', (e) => {
                ...
                cockpitTargetRotY = Math.max(-Math.PI / 3, Math.min(Math.PI / 3, cockpitTargetRotY));  // ±60° (쉘 가장자리 안 보이게)
            ...
            // ★ 터치로 고개 돌리기 - initPilotJoystick에서 듀얼 터치로 통합 처리
            // (기존 코드 제거 - 간섭 방지)
        }
        ...
        function initPilotControls() {
            ...
            window.addEventListener('keydown', (e) => {
                ...
                // ★★★ WASD 선회 조작 (1인칭 조종석에서만, 자동항법 아닐 때) ★★★
                if (isCockpitView && !autopilot.engaged) {
                    ...
                    // 선회 입력 적용 (조이스틱 방향과 일치)
                    shipInputs.pitch = (keyState.w ? 1 : 0) + (keyState.s ? -1 : 0);  // W=기수 하강, S=기수 상승
                    shipInputs.yaw = (keyState.a ? 1 : 0) + (keyState.d ? -1 : 0);    // A=좌회전, D=우회전
                }

                // 속도 조절 (화살표 키 - 3인칭에서도 허용)
                if (!autopilot.engaged) {
            ...
            // ★ 마우스 좌클릭은 시야 회전용으로 유지 (발사 제거됨 - Q키 사용)

            // ★★★ 모바일 듀얼 터치 컨트롤 시스템 (개선됨) ★★★
            // 왼쪽 터치 (0-50%): 우주선 선회 (yaw, pitch) - 가상 조이스틱 방식
            // 오른쪽 터치 (50-100%): 시야 변경 (조준용)
            ...
            let leftTouchCenter = { x: 0, y: 0 };  // 터치 시작점 = 조이스틱 중심 (고정)
            // 오른쪽 터치 (시야)
            ...
            function isUIElement(el) {
                ...
                return (
                    ...
                    (el.tagName === 'BUTTON' && el.id !== '') ||  // ID 있는 버튼만
                    el.tagName === 'INPUT' ||
                    el.tagName === 'SELECT' ||
                    el.tagName === 'LABEL'
                );
            ...
            // ★★★ 터치 시작 - 화면 전체에서 좌우 분리 (document 레벨) ★★★
            document.addEventListener('touchstart', (e) => {
                ...
                for (let i = 0; i < e.changedTouches.length; i++) {
                    ...
                    // 상단 10%, 하단 5%는 무시 (더 넓은 터치 영역)
                    if (ty < screenH * 0.10 || ty > screenH * 0.95) continue;

                    // ★★★ 왼쪽 절반 (0 ~ 50%): 선회 조작 (가상 조이스틱) ★★★
                    if (tx < screenW * 0.50 && leftTouchId === null) {
                        leftTouchId = touch.identifier;
                        leftTouchCenter = { x: tx, y: ty };  // 터치 시작점이 조이스틱 중심
                        console.log('★ 왼쪽 터치 시작:', tx, ty, '화면절반:', screenW * 0.5);
                        e.preventDefault();
                    }
                    // ★★★ 오른쪽 절반 (50% ~ 100%): 시야 조작 ★★★
                        ...
                        console.log('★ 오른쪽 터치 시작:', tx, ty);
                        e.preventDefault();
                    }
                }
            }, { passive: false });

            // ★★★ 터치 이동 - 좌우 독립 처리 (document 레벨) ★★★
            ...
            document.addEventListener('touchend', (e) => {
                for (let i = 0; i < e.changedTouches.length; i++) {
                    ...
                    if (touch.identifier === leftTouchId) {
                        ...
                        shipInputs.yaw = 0;
                        shipInputs.pitch = 0;
                        console.log('★ 왼쪽 터치 종료');
                    }

                    if (touch.identifier === rightTouchId) {
                        rightTouchId = null;
                        // 시야는 유지 (초기화 안함)
                        console.log('★ 오른쪽 터치 종료');
                    }
                }
            });
        ...
        function enableAutopilot() {
            ...
            AudioManager.playSFX('sfx_autopilot');  // ★ 오토파일럿 효과음
        ...
        function applyDamageToPlayer(damage) {
            ...
            // 경고 메시지
            showMsg(`⚠️ 피격! 내구도: ${Math.round(playerShip.hull)}%`);
        ...
        function handleShipDestruction() {
            ...
            // 파괴된 우주선 정보 저장
            const destroyedShipName = currentShipType ? getShipName(currentShipType) : '우주선';
            ...
            setTimeout(() => {
                ...
                // 리스폰 메시지
                showMsg(`⚠️ ${destroyedShipName}이(가) 파괴되었습니다! 우주정거장에서 새 우주선을 탑승하세요.`);

                // ARIA 안내 메시지
                if (typeof aiTypeMessage === 'function') {
                    setTimeout(() => {
                        aiTypeMessage('파일럿님, 안타깝게도 우주선이 파괴되었습니다. 가까운 우주정거장에서 새 우주선을 받으실 수 있습니다. 정거장을 클릭하여 도킹 메뉴에서 "탑승"을 선택하세요.');
                    }, 2000);
                }
            }, 2000);
        }
        ...
        function createExplosionEffect(position) {
            const particleCount = 60;  // 더 많은 파티클
            const particles = [];
            ...
            for (let i = 0; i < particleCount; i++) {
                ...
                particle.userData.lifetime = Math.random() * 1.5 + 1;  // 1~2.5초
            ...
            for (let i = 0; i < 15; i++) {
                ...
                debris.userData.lifetime = Math.random() * 2 + 2;  // 2~4초
        ...
        function initBackgroundWorker() {
            ...
            try {
                ...
                console.log('✅ Background Worker 초기화 완료');
            } catch (e) {
                console.log('⚠️ Background Worker 초기화 실패:', e);
            }
        }
        ...
        document.addEventListener('visibilitychange', () => {
            ...
            if (!isPageVisible) {
                ...
                if (backgroundState.wasInPilotMode && playerShip && playerShip.mesh && backgroundState.lastPosition) {
                    ...
                    showMsg(`📱 복귀 - ${elapsedSec.toFixed(0)}초 동안 ${Math.round(traveled)} 단위 이동`);
                }
        ...
        function animate() {
            ...
            satellites.forEach(sat => {
                if (sat && sat.parentBody && sat.parentBody.mesh && sat.mesh) {
                    ...
                    // ★★★ 멀티모드: 서버 동기화 시간 기준 공전 ★★★
                    if (window.gameMode === 'multi') {
                        // 위성별 고유 시드 (이름 기반) + 서버 동기화 시간 기반 공전
                        const seed = sat.name ? sat.name.split('').reduce((a, c) => a + c.charCodeAt(0), 0) : 0;
                        const syncedTime = typeof getSyncedTime === 'function' ? getSyncedTime() : Date.now();
                        const baseTime = syncedTime * 0.0000001;  // 느린 공전
                        sat.angle = (seed * 0.1 + baseTime * sat.orbitSpeed) % (Math.PI * 2);
                    } else {
                        // 싱글모드: 기존 방식 (상대적 누적)
                ...
                if (isObservatoryMode) {
                    ...
                    if (cockpit) {
                        if (isCockpitView) {
                            ...
                            // 조종석 재질 정상화 (HUD 패널 제외)
                            cockpit.traverse(obj => {
                                if (obj.isMesh && obj.material) {
                                    // ★★★ HUD 패널은 depthTest: false 유지 (클리핑 방지)
                                    if (obj.material.blending === THREE.AdditiveBlending) {
                                        // HUD 패널은 AdditiveBlending 사용 - 건드리지 않음
                                        return;
                                    }
                            ...
                            // 단일 패스 렌더링 (조종실이 카메라에 가까워서 자연스럽게 앞에 렌더링됨)
                            renderer.render(scene, camera);
                        } else {
        ...
        function startGameMode(mode) {
            ...
            if (mode === 'multi') {
                ...
                (async function loadMultiplayerData() {
                    console.log('🔄 멀티모드: 서버에서 게임 데이터 로딩...');
                    try {
                        ...
                        console.log('✅ 멀티모드: 게임 데이터 로드 완료');
                    } catch (e) {
                        console.warn('멀티모드 데이터 로드 중 오류:', e);
                    }
                })();
        ...
        const draggableUISystem = {
            ...
            // 드래그 가능한 UI 요소 ID 목록 (모든 조종실 UI)
            draggableIds: [
                'pilot-top-bar',           // 상단 바 (상태, 능력)
                'pilot-left-console',      // THR/FUEL 게이지
                'pilot-center-console',    // 속도 + 버튼들
                'pilot-right-console',     // ▲▼ 버튼
                'pilot-right',             // 레이더 + TARGET + AUTOPILOT
                'pilot-radar',             // 레이더
                'pilot-target-info',       // 타겟 정보
                'pilot-autopilot-info',    // 오토파일럿 정보
                'pilot-eta-box',           // ETA 박스
                'pilot-warning-panel',     // 경고 패널
                'pilot-target-select',     // 목표 선택
                'pilot-coords-panel',      // 좌표 패널
                'pilot-bottom',            // 하단 버튼들
                'pilot-joystick',          // 조이스틱
                'cockpit-radio',           // 라디오
                'unified-chat-panel',      // 통합 채팅
                'docking-center-btn',      // 도킹 버튼
                'docking-menu',            // 도킹 메뉴
                'crosshair',               // 조준선
                'status-panel',            // 상태 패널
                'ai-copilot-panel',        // AI 코파일럿
                'multiplayer-ui',          // 멀티플레이어 UI
                'pilot-right-btns',        // ★ 통일된 우측 버튼 컨테이너
                'ui-settings-btn',         // 설정 버튼
                'ssil-mission-panel',      // SSIL 훈련 프로그램
                'mission-float-btn',       // 미션 플로팅 버튼
                'mission-board-modal',     // 임무 지시서
                'daily-mission-icon',      // ★ 업무 지시서 (편지봉투)
                'ad-rewards-panel',        // 광고 보상 패널
                'ad-menu-toggle',          // 광고 메뉴 버튼
                'mobile-combat-btns'       // ★ 발사/역추진 버튼 컨테이너
            ],
            ...
            initSettingsPanel() {
                ...
                console.log('⚙️ initSettingsPanel - btn:', !!btn, 'panel:', !!panel);

                if (btn) {
                    btn.onclick = () => {
                        console.log('⚙️ Settings btn clicked, toggling panel');
                        panel?.classList.toggle('open');
        ...
        const uiRearrangeSystem = {
            ...
            startPos: { x: 0, y: 0 },
            elementStartPos: { x: 0, y: 0 },
            gridSize: 20,  // ★ 그리드 스냅 크기 (px)
            
            // 재배치 가능한 UI 요소 ID 목록 (모든 조종실 UI)
            rearrangeableIds: [
                'pilot-top-bar',           // 상단 바 (상태, 능력)
                'pilot-left-console',      // THR/FUEL 게이지
                'pilot-center-console',    // 속도 + 버튼들
        ...
        // 조종 모드 진입 시 초기화
        window.initDraggableUI = () => {
            console.log('🔧 initDraggableUI 호출됨');
            // 약간의 지연 후 초기화 (DOM이 준비되도록)
            setTimeout(() => {
                console.log('🔧 draggableUISystem.init() 호출 시작');
                ...
                console.log('🔧 initDraggableUI 완료');
            }, 100);
        };
